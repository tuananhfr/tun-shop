...
function Products() {
    ...
    const filterProduct = (cat) => {
        const update = data.filter((x) => x.category.includes(cat));
        setFilter(update);
    };
        ...
        return (
            <>
                <div className="buttons d-flex justify-content-center mb-5 pb-5">
                    <button className="btn btn-outline-dark me-2" onClick={() => filter(data)}>
                        All
                    </button>
                            ...
                            <div className="col-md-3 mb-4" key={product.id}>
                                <div className="card h-100 text-center p-4">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title mb-0">{product.title.split(' ', 3).join(' ')} ...</h5>
